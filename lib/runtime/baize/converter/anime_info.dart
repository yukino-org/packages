...
class TenkaBaizeAnimeInfoConvertable extends TenkaBaizeConvertable<AnimeInfo> {
  TenkaBaizeAnimeInfoConvertable(super.converter);
  ...
  AnimeInfo convert(
    ...
    final BaizeValue episodes =
        casted.getNamedProperty(TenkaBaizeConverter.kEpisodes);
...
extension TenkaBaizeAnimeInfoConverter on TenkaBaizeConverter {
  TenkaBaizeAnimeInfoConvertable get animeInfo =>
      TenkaBaizeAnimeInfoConvertable(this);
}
