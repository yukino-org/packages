...
abstract class LanguageUtils {
  static Map<LanguageCodes, String> codeNameMap = <LanguageCodes, String>{
  ...
  static final Map<String, LanguageCodes> nameCodeMap = LanguageCodes.values
      .asMap()
      .map(
...
abstract class CountryUtils {
  static Map<CountryCodes, String> codeNameMap = <CountryCodes, String>{
  ...
  static final Map<String, CountryCodes> nameCodeMap = CountryCodes.values
      .asMap()
      .map(
